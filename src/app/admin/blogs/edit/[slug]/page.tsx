    ...
    <div className="bg-cream-100 min-h-screen p-8 text-charcoal-800">
      <div className="max-w-6xl mx-auto">
        <header className="flex items-center gap-6 mb-12">
          ...
          <h1 className="font-display text-4xl text-brown-800">Edit Insight</h1>
        </header>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white rounded-sm border border-cream-200 shadow-sm p-8">
              ...
              <div className="mb-6">
                ...
                <input 
                  ...
                  disabled
                  value={formData.slug}
                  className="w-full bg-cream-50 border border-cream-200 rounded-md px-4 py-2 font-mono text-sm opacity-50 cursor-not-allowed"
                />
              </div>

              <div className="mb-6">
                <label className="block font-body text-xs font-bold uppercase tracking-widest text-charcoal-400 mb-2">Excerpt</label>
                <textarea 
                  name="excerpt"
                  required
                  rows={3}
            ...
            <div className="bg-white rounded-sm border border-cream-200 shadow-sm p-8">
              ...
              <div className="mb-6">
                <label className="block font-body text-xs font-bold uppercase tracking-widest text-charcoal-400 mb-2">Meta Description</label>
                <textarea 
              ...
              <div>
                <label className="block font-body text-xs font-bold uppercase tracking-widest text-charcoal-400 mb-2">Focus Keywords</label>
