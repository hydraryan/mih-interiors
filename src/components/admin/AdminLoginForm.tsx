...
export default function AdminLoginForm() {
  ...
  return (
    <main suppressHydrationWarning className="min-h-screen bg-[#ede6dc] text-charcoal-900">
            ...
            <div className="rounded-lg border border-white bg-[#fffdf9] p-6 shadow-[0_28px_70px_rgba(48,32,19,0.18)] sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex justify-end">
                  <Link
                    href={urls.admin('/login/forgot-password')}
                    className="text-xs font-semibold text-brown-800 underline decoration-[#b89767] decoration-2 underline-offset-4 transition hover:text-brown-900"
                  >
                    Forgot password?
                  </Link>
                </div>
