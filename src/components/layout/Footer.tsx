...
export default function Footer() {
  ...
  return (
    <footer id="footer" className="w-full bg-cream-100 pb-0 overflow-hidden">
      ...
      {/* ── Copyright Bar ── */}
      <div className="max-w-350 mx-auto px-6 md:px-12 pb-4 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-body text-charcoal-900/40 border-t border-charcoal-900/5 pt-5">
        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-center sm:text-left">
          <p>© {new Date().getFullYear()} MIH Interiors. All rights reserved.</p>
          <span className="hidden sm:inline-block text-charcoal-900/20">|</span>
          <p>
            Designed and developed with <span className="text-red-500/80">❤️</span> by <a href="https://www.promoora.in" target="_blank" rel="noopener noreferrer" className="hover:text-amber-600 transition-colors font-semibold text-charcoal-900/60">Promoora</a>
          </p>
        </div>
